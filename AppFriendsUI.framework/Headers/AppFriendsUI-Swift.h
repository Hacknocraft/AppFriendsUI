...
#ifndef APPFRIENDSUI_SWIFT_H
#define APPFRIENDSUI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AppFriendsUI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
typedef SWIFT_ENUM(NSInteger, AFAttachmentType, closed) {
...
typedef SWIFT_ENUM(NSInteger, AFDialogType, closed) {
...
typedef SWIFT_ENUM(NSInteger, AFEventName, closed) {
...
typedef SWIFT_ENUM(NSInteger, AFGifContentRating, closed) {
...
typedef SWIFT_ENUM(NSInteger, AFGifContentType, closed) {
...
typedef SWIFT_ENUM(NSInteger, AFMessageSendingStatus, closed) {
...
- (NSDictionary<NSAttributedStringKey, id> * _Nonnull)linkTextAttributesWithIsOutGoingMessage:(BOOL)out SWIFT_WARN_UNUSED_RESULT;
...
@interface HCContactsViewController : HCBaseViewController <UITableViewDataSource, UITableViewDelegate>
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)numberOfSectionsInTableView:(UITableView * _Nonnull)tableView SWIFT_WARN_UNUSED_RESULT;
...
typedef SWIFT_ENUM(NSInteger, HCSideDirection, closed) {
...
typedef SWIFT_ENUM(NSInteger, HCSidePanelBackgroundMode, closed) {
