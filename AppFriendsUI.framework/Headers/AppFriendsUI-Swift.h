...
- (void)initialize:(NSString * _Nonnull)appKey secret:(NSString * _Nonnull)secret completion:(void (^ _Nullable)(BOOL success, NSError * _Nullable error))completion;
...
- (void)followUser:(NSString * _Nonnull)userID completion:(void (^ _Nullable)(id _Nullable response, NSError * _Nullable error))completion;
- (void)unfollowUser:(NSString * _Nonnull)userID completion:(void (^ _Nullable)(id _Nullable response, NSError * _Nullable error))completion;
- (void)blockUser:(NSString * _Nonnull)userID completion:(void (^ _Nullable)(id _Nullable response, NSError * _Nullable error))completion;
- (void)unblockUser:(NSString * _Nonnull)userID completion:(void (^ _Nullable)(id _Nullable response, NSError * _Nullable error))completion;
- (void)fetchFollowers:(NSString * _Nonnull)userID completion:(void (^ _Nullable)(id _Nullable response, NSError * _Nullable error))completion;
- (void)fetchFollowings:(NSString * _Nonnull)userID completion:(void (^ _Nullable)(id _Nullable response, NSError * _Nullable error))completion;
- (void)searchUser:(NSString * _Nonnull)query completion:(void (^ _Nullable)(id _Nullable response, NSError * _Nullable error))completion;
- (void)fetchUserFriends:(NSString * _Nonnull)userID completion:(void (^ _Nullable)(id _Nullable response, NSError * _Nullable error))completion;
- (void)updateUserInfo:(NSString * _Nonnull)userID userInfo:(NSDictionary<NSString *, id> * _Nonnull)userInfo completion:(void (^ _Nullable)(id _Nullable response, NSError * _Nullable error))completion;
- (void)fetchUserInfo:(NSString * _Nonnull)userID completion:(void (^ _Nullable)(id _Nullable response, NSError * _Nullable error))completion;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
- (void)fetchChannelInfo:(NSString * _Nonnull)channelID completion:(void (^ _Nullable)(NSError * _Nullable error))completion;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
- (void)initialize:(void (^ _Nullable)(BOOL success, NSError * _Nullable error))completion;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
- (void)updateDialogName:(NSString * _Nonnull)dialogID dialogName:(NSString * _Nonnull)dialogName completion:(void (^ _Nullable)(NSError * _Nullable error))completion;
- (void)fetchDialogInfo:(NSString * _Nonnull)dialogID completion:(void (^ _Nullable)(NSError * _Nullable error))completion;
- (void)addMembersToDialog:(NSString * _Nonnull)dialogID members:(NSArray<NSString *> * _Nonnull)newMembers completion:(void (^ _Nullable)(NSError * _Nullable error))completion;
- (void)leaveGroupDialog:(NSString * _Nonnull)dialogID completion:(void (^ _Nullable)(NSError * _Nullable error))completion;

/// Getting the list of dialogs
///
/// \param completion complete block, invoked when the request is completed
- (void)fetchDialogs:(void (^ _Nullable)(NSError * _Nullable error))completion;
- (void)muteDialog:(NSString * _Nonnull)dialogID muted:(BOOL)muted completion:(void (^ _Nullable)(NSError * _Nullable error))completion;
...
@property (nonatomic, strong) NSDate * _Nullable lastMessageReadTime;
@property (nonatomic, copy) NSString * _Nullable lastMessageText;
@property (nonatomic, strong) NSDate * _Nullable lastMessageTime;
...
@property (nonatomic, strong) NSDate * _Nullable messageTime;
...
@interface HCDialogsListViewController : HCBaseViewController <DZNEmptyDataSetDelegate, DZNEmptyDataSetSource, SESlideTableViewCellDelegate, UITableViewDelegate, UIScrollViewDelegate, UITableViewDataSource>
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tableView;
- (void)viewDidLoad;
- (void)viewDidAppear:(BOOL)animated;
- (void)didReceiveMemoryWarning;
- (NSAttributedString * _Null_unspecified)titleForEmptyDataSet:(UIScrollView * _Null_unspecified)scrollView;
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section;
- (NSInteger)numberOfSectionsInTableView:(UITableView * _Nonnull)tableView;
- (CGFloat)tableView:(UITableView * _Nonnull)tableView heightForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
...
@property (nonatomic, strong) NSDate * _Nullable receiveTime;
...
@property (nonatomic, strong) NSDate * _Nullable sentTime;
