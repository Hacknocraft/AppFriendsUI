...
typedef SWIFT_ENUM(NSInteger, AFAttachmentType, open) {
...
typedef SWIFT_ENUM(NSInteger, AFDialogType, open) {
...
typedef SWIFT_ENUM(NSInteger, AFEventName, open) {
...
typedef SWIFT_ENUM(NSInteger, AFGifContentRating, open) {
...
typedef SWIFT_ENUM(NSInteger, AFGifContentType, open) {
...
typedef SWIFT_ENUM(NSInteger, AFMessageSendingStatus, open) {
...
typedef SWIFT_ENUM(NSInteger, HCSideDirection, open) {
...
typedef SWIFT_ENUM(NSInteger, HCSidePanelBackgroundMode, open) {
